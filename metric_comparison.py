...
clfs = [svm.SVC(kernel='linear',gamma=0.01, C=1),
...
for i,clf in enumerate(clfs):
    ...
    test_result[classifier_name[i]] = np.array([y_test,y_predict])
    # print(y_score)
...
test_path='C:/Users/Administrator/Desktop/对比算法/result_fig/test_result_3method.txt'
